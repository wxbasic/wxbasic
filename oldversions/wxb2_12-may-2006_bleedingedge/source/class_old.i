...
// events
%num wxEVT_COMMAND_SPLITTER_SASH_POS_CHANGING
%num wxEVT_COMMAND_SPLITTER_SASH_POS_CHANGED
%num wxEVT_COMMAND_SPLITTER_DOUBLECLICKED
%num wxEVT_COMMAND_SPLITTER_UNSPLIT
