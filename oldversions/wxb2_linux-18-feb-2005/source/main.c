...
#define W_RELEASE     "alpha 2.2c (Deep Dish Pizza)"
#define W_DATEOF      "February 18, 2005"
#define W_COPYRIGHT   "(c) 2005 David Cuny"
...
int wMainParseDirectives( int argc, char *argv[] )
{
    ...
    for ( i = 1; i < argc; i++ ) {
        ...
        if (flag) {
            ...
            if (strcmp( arg, "d") == 0
            ||  strcmp( arg, "debug") == 0) {
                wTheDebugFlag = W_TRUE;

            /* trace */
            } else if (strcmp( arg, "t" ) == 0
              ||       strcmp( arg, "trace") == 0) {
                wTheTraceFlag = W_TRUE;
...
// wErrorMessage( "Debug:", "calling wMemInit" );
    /* initialize memory tracking */
    wMemInit();

// wErrorMessage( "Debug:", "set memory tracking" );
...
// wErrorMessage( "Debug:", "get offset" );
    ...
    /* FIXME: this might cause errors, since it's not tracked */
    ...
    if (!wTheCwd) {
        ...
        /* this is the preferred method on *nix systems */
        // wTheCwd = wCharCopy( "." );
    }
...
#ifdef __WXWIN__
        wxMessageBox("Created output file \"wx.log\"");
#endif
