...
#ifndef WXBASIC_BUILTIN_DECLARES
#define WXBASIC_BUILTIN_DECLARES
...
void wBuiltinBase(void);
void wBuiltinBin(void);
...
void wBuiltinSpace(void);
    ...
    void wBuiltinSqlClose(void);
    void wBuiltinSqlExec(void);
    void wBuiltinSqlOpen(void);
#endif
...
#ifdef __SQLITE__
    {"sqlClose",        wBuiltinSqlClose,        0,  0},
    {"sqlExec",         wBuiltinSqlExec,         1,  0},
    {"sqlOpen",         wBuiltinSqlOpen,         1,  0},
#endif
