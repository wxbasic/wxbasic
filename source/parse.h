...
#ifndef WXBASIC_PARSE_DECLARES
#define WXBASIC_PARSE_DECLARES
...
void wParseProperties( void );
void wParseSharedProperties( void );
...
wCode *wParseStatementStatic( void );
